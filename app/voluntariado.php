<?php
 include 'index.html';
 ?>
 <section class="voluntariado py-5">
  <div class="container">
    <h2 class="text-center mb-5">¡Haz la diferencia! Sé voluntario</h2>
    <div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <a href="#" class="btn btn-primary mt-3">Solicitud de voluntariado</a>
      </div>
    </div>
  </div>
</section>
